...
SELECT code, omschrijving, lengte FROM cursussen WHERE lengte = 4;
...
SELECT cursus, begindatum, locatie FROM uitvoeringen
...
INSERT INTO uitvoeringen (cursus, begindatum, locatie, docent) VALUES ('S02', '2020-03-02', 'LEERDAM', 7369);
...
INSERT INTO medewerkers (mnr, naam, voorl, functie, gbdatum, maandsal, afd) VALUES (801, 'Ulenbelt', 'I', 'STAGIAIR', '2004-10-06', 200.00, 10);
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
VALUES
    ('D&P', '2024-04-01', 7566, 'LEERDAM'),
    ('D&P', '2025-12-01', 7566, 'LEERDAM');

INSERT INTO inschrijvingen (cursist, cursus, begindatum)
VALUES
    (7499, 'D&P', '2024-04-01'),
    (7521, 'D&P', '2024-04-01'),
    (7566, 'D&P', '2024-04-01')                                                                                      -- [TEST]
...
WHERE afd = 20 AND functie <> 'MANAGER';
...
DELETE FROM medewerkers WHERE mnr = 7654;                                   -- [TEST]
...
-- Dit lukt niet omdat Alders nog is ingeschreven in een cursus.                                                                                         -- [TEST]
...
INSERT INTO medewerkers (mnr, naam, voorl, functie, gbdatum, maandsal, afd) VALUES (802, 'Ulenbelt', 'I', 'STAGIAIR', '2004-10-06', 200.00, 10);

INSERT INTO afdelingen (anr, naam, locatie, hoofd)
VALUES (50, 'FINANCIEN', 'LEERDAM', 802)                                                                              -- [TEST]

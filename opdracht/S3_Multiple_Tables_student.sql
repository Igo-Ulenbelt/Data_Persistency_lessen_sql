...
SELECT m.naam AS cursist, m2.naam AS docent, u.cursus FROM inschrijvingen as i INNER JOIN medewerkers as m ON i.cursist = m.mnr INNER JOIN uitvoeringen as u ON i.cursus = u.cursus INNER JOIN medewerkers as m2 ON u.docent = m2.mnr WHERE u.cursus = 'S02'
...
SELECT i.cursus, i.begindatum, m.naam FROM inschrijvingen as I  INNER JOIN medewerkers as m ON i.cursist = m.mnr WHERE i.begindatum = '2019-04-12'

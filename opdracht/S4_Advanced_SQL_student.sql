...
SELECT naam AS volledige_naam FROM medewerkers WHERE naam LIKE '% %';
...
SELECT m.mnr, i.cursus as agevolgd FROM medewerkers as m
...
SELECT
    ...
    ROUND(AVG(COALESCE(comm, 0)), 2) AS commissie_medewerkers,

...
-- Test de regel door een illegale waarde in te voegen
-- UPDATE medewerkers SET geslacht = 'X' WHERE mnr = 8000;
...
INSERT INTO medewerkers (mnr, naam, voorl, functie, afd, chef, geslacht, gbdatum, maandsal)
VALUES (8000, 'DONK', 'A', 'HOOFDKANTOOR', 50, NULL, 'M', '1975-06-15', 4000);
...
VALUES (nextval('afdeling_seq'), 'VERKOOP', 'LEIDEN');
...
VALUES ('1234AB', 10, '2023-01-01', '2023-12-31', '0612345678', 8000);
